...
object getTracks {
    @JvmStatic
    fun main(episodeToParse: Episode): Episode {
        ...
        if (episodeToParse.contentEncoded != null) {
            ...
            if (doNotUseContentEncoded == false) {
    ...
    private fun linebreakCompare(str1: String, str2: String): Boolean {
